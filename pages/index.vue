<template>
  <div>
    <section class="lg:tw-mx-12 tw-mx-8">
      <div class="tw-py-20 tw-rounded-lg tw-shadow-lg tw-shadow-gray-500 tw-h-full tw-w-full">
    ...
    <section class="service tw-p-6 tw-px-24 tw-pt-24">
      ...
      <v-row>
        <v-col class="" cols="12" md="6" lg="6">
          ...
          <div
            class="tw-flex lg:tw-transform lg:tw--translate-y-40 lg:tw-translate-x-72 bg-hover tw-flex-col lg:tw-w-1/2 tw-gap-4 tw-bg-transparent tw-shadow-gray-400 tw-shadow-xl tw-p-6 tw-rounded-lg">
            <svg width="75" fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 496 496" xml:space="preserve">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
    ...
    <section class="tw-p-6 tw-px-24 tw-pt-24">
      ...
      <v-row class="tw-mx-8" data-aos="fade-up">

        <v-col class="" cols="12" md="4" lg="4">


          <v-img class="tw-rounded-lg tw-cursor-pointer tw-rounded-lg tw-shadow-xl"
        ...
        <v-col class="" cols="12" md="4" lg="4">
          ...
          <v-img class="tw-rounded-lg tw-cursor-pointer tw-rounded-lg tw-shadow-xl"
            src="https://img.freepik.com/premium-vector/social-media-network-digital-communication-concept-website-landing-page-template_348082-2153.jpg?size=626&ext=jpg"
            width="450px"></v-img>
        </v-col>
